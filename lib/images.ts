...
export const SITE_IMAGE_DEFAULT_PATH: Record<SiteImageKey, string> = {
  ...
  // 2번째 이미지는 기본값 없음 — 관리자가 등록해야 캐러셀로 노출된다.
  layout_cabana_2: '',
...
export const SITE_IMAGE_LABEL: Record<SiteImageKey, string> = {
  ...
  layout_cabana: '평상&케노피 배치도 (시설 배치도 탭) 1',
  layout_cabana_2: '평상&케노피 배치도 (시설 배치도 탭) 2',
  cabana_diagram: '평상&케노피 안내 이미지 (예약 섹션) 1',
  cabana_diagram_2: '평상&케노피 안내 이미지 (예약 섹션) 2',
  train: '신나는기차 이미지',
  car: '마이카 이미지',
...
export const SITE_IMAGE_RECOMMENDED: Record<SiteImageKey, string> = {
  ...
  layout_cabana_2: '1050 × 824',
  cabana_diagram: '1050 × 824',
  cabana_diagram_2: '1050 × 824',
  train: '800 × 600',
  car: '800 × 600',

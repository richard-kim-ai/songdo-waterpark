...
const SECTIONS: { title: string; description?: string; fields: FieldConfig[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'info_pool_season_label', label: '"운영 시즌" 항목 라벨' },
      { key: 'pool_season', label: '물놀이장 운영 시즌' },
      { key: 'info_pool_weekday_label', label: '"평일 운영" 항목 라벨' },
      { key: 'pool_weekday_hours', label: '물놀이장 평일 운영시간' },
      { key: 'info_pool_weekend_label', label: '"주말 운영" 항목 라벨' },
      { key: 'pool_weekend_hours', label: '물놀이장 주말 운영시간' },
      { key: 'info_pool_last_entry_label', label: '"입장 마감" 항목 라벨' },
      { key: 'pool_last_entry', label: '물놀이장 입장 마감 안내' },
      { key: 'info_cabana_open_label', label: '"케노피 이용" 항목 라벨' },
      { key: 'cabana_open_hours', label: '케노피 이용시간' },
      { key: 'info_cabana_usage_label', label: '"이용 시간" 항목 라벨' },
